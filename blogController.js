...
exports.supplyDetails = async (req, res) => {
  dbconnnectivity.query('SELECT * FROM suppliers', function (err, result) {
...
exports.supplyDetailsById = async (req, res) => {
  const supp = req.params.id;
  dbconnnectivity.query('SELECT * FROM suppliers where supplier_id = ' + supp, function (err, result) {
    if (err) res.status(500).send({error: 'Something Worng'});
    if (result) {
      res.json({res: result});
    }
...
exports.deleteSupplyDetailsById = async (req, res) => {
  const supp = req.params.id;
  dbconnnectivity.query('delete FROM suppliers where supplier_id = ' + supp, function (err, result) {
    if (err) res.status(500).send({error: 'Something Worng'});
    if (result) {
      res.json({res: result});
    }
...
exports.employeeDetails = async (req, res) => {
  dbconnnectivity.query('SELECT * FROM employees', function (err, result) {
    if (err) res.status(500).send({error: 'Something Worng'});
    if (result) {
      res.json({res: result});
    }
...
exports.employeeDetailsById = async (req, res) => {
  ...
  dbconnnectivity.query('SELECT * FROM employees where employee_number = ' + empid, function (err, result) {
    if (err) res.status(500).send({error: 'Something Worng'});
    if (result) {
      res.json({res: result});
    }
...
exports.deleteEmployeeDetailsById = async (req, res) => {
  const empid = req.params.id;
  dbconnnectivity.query('delete FROM employees where employee_number = ' + empid, function (err, result) {
    if (err) res.status(500).send({error: 'Something Worng'});
    if (result) {
      res.json({res: result});
    }
